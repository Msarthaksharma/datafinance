        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col justify-center'>
                ...
                <p>
                   ...
                   Adipisci facere quisquam debitis voluptate aperiam obcaecati soluta, 
                   eos voluptas totam corporis earum sequi exercitationem, molestiae ipsam 
                   labore, rerum aliquam maiores? Ullam.
                </p>
